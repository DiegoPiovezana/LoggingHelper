...
namespace LH
{
    internal static class WriteLog
    {
        ...
        restart:
            try
            {
                var output = Treatment.FormatLog(LoggingHelper.FormatLogOutput, message, levelMessage, nameMethod, obs);
        ...
        internal static bool ToTrace(string message, string levelMessage, string nameMethod, string obs)
        {
            try
            {
